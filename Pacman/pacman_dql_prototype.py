...
def get_state_discrete(player, ghosts, powerup_counter, level_board, pellets_group, power_pellets_group, initial_pellet_count, initial_power_pellet_count, turns_since_pellet):
    ...
    # --- ADIÇÃO DAS NOVAS FEATURES DE LOCALIZAÇÃO ---
    """
...
def main():
    ...
    log_file_path = 'prototype_training_log.csv'
    ...
    for episode in range(nTreino + nRender):
        ...
        for turn in range(25000): # Limite de turnos para evitar loops infinitos
            ...
            penalty_level = turns_since_pellet // TURNS_PER_PENALTY_INCREASE
